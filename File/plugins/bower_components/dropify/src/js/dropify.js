...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        messages: {
            'default': 'Arrastra y suelta la imagen para guardar',
            'replace': 'Arrastra y suelta la imagen para remplazar',
            'remove':  'Quitar',
            'error':   'Ooops, un error abriendo la imagen.'
        },
        error: {
            'fileSize': 'La imagen es demaciado grande ({{ value }} max).',
            'minWidth': 'La imagen es demaciado pequeña ({{ value }}}px min).',
            'maxWidth': 'El tamaño de la imagen es demaciado grande ({{ value }}}px max).',
            'minHeight': 'La imagen tiene un peso pequeño ({{ value }}}px min).',
            'maxHeight': 'La imagen tiene un peso grande ({{ value }}px max).',
            'imageFormat': 'El formato no es valido ({{ value }} only).'
        },
        tpl: {
