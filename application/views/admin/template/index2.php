                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-lg-4">
                        <div class="panel">
                            <div class="p-30">
                                <div class="row">
                                    <div class="col-xs-4"><img src="<?php echo base_url() ?>File/plugins/images/users/varun.jpg" alt="varun" class="img-circle img-responsive"></div>
                                    <div class="col-xs-8">
                            ...
                            <div class="p-20 text-center">
                                ...
                                <ul class="dp-table m-t-30">
                                    <li><img src="<?php echo base_url() ?>File/plugins/images/users/varun.jpg" alt="varun" width="60" data-toggle="tooltip" title="Varun Dhavan" class="img-circle"></li>
                                    <li><img src="<?php echo base_url() ?>File/plugins/images/users/genu.jpg" alt="varun" width="60" data-toggle="tooltip" title="Varun Dhavan" class="img-circle"></li>
                                    <li><img src="<?php echo base_url() ?>File/plugins/images/users/pawandeep.jpg" alt="varun" width="60" data-toggle="tooltip" title="Varun Dhavan" class="img-circle"></li>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-footer bg-extralight">
                                <ul class="earning-box">
                                    ...
                                    <li>
                                        <div class="er-row">
                                            <div class="er-pic"><img src="<?php echo base_url() ?>File/plugins/images/users/hritik.jpg" alt="varun" width="60" class="img-circle"></div>
                                            <div class="er-text">
