    ...
    ?>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url() ?>File/plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="<?php echo base_url() ?>File/plugins/images/users/genu.jpg" class="thumb-lg img-circle" alt="img"></a>
                        ...
                        <div class="white-box">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="home">
                                    <div class="steamline">
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="<?php echo base_url() ?>File/plugins/images/users/genu.jpg" alt="user" class="img-circle" /> </div>
                                            <div class="sl-right">
                                                <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                    <p>assign a new task <a href="#"> Design weblayout</a></p>
                                                    <div class="m-t-20 row"><img src="<?php echo base_url() ?>File/plugins/images/img1.jpg" alt="user" class="col-md-3 col-xs-12" /> <img src="<?php echo base_url() ?>File/plugins/images/img2.jpg" alt="user" class="col-md-3 col-xs-12" /> <img src="<?php echo base_url() ?>File/plugins/images/img3.jpg" alt="user" class="col-md-3 col-xs-12" /></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="<?php echo base_url() ?>File/plugins/images/users/sonu.jpg" alt="user" class="img-circle" /> </div>
                                            <div class="sl-right">
                                                <div class="m-l-40"> <a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                    <div class="m-t-20 row">
                                                        <div class="col-md-2 col-xs-12"><img src="<?php echo base_url() ?>File/plugins/images/img1.jpg" alt="user" class="img-responsive" /></div>
                                        ...
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="<?php echo base_url() ?>File/plugins/images/users/ritesh.jpg" alt="user" class="img-circle" /> </div>
                                            <div class="sl-right">
                                                <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                        ...
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="<?php echo base_url() ?>File/plugins/images/users/govinda.jpg" alt="user" class="img-circle" /> </div>
                                            <div class="sl-right">
                                                <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                    <p>assign a new task <a href="#"> Design weblayout</a></p>
                                                </div>
