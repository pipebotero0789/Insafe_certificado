...
<head>
    ...
    <!-- Wizard CSS -->
    <link href="<?php echo base_url() ?>File/plugins/bower_components/register-steps/steps.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo base_url() ?>File/css/admin/style.css" rel="stylesheet">
    <!-- color CSS -->
    <link href="<?php echo base_url() ?>File/css/admin/colors/default.css" id="theme" rel="stylesheet">
...
<section id="wrapper" class="step-register">
  <div class="register-box">
    <div class="">
       <a href="javascript:void(0)" class="text-center db m-b-40"><img src="<?php echo base_url() ?>File/plugins/images/admin-logo-dark.png" alt="Home" /><br/><img src="<?php echo base_url() ?>File/plugins/images/admin-text-dark.png" alt="Home" /></a>
      <!-- multistep form -->
        <form id="msform">
        <!-- progressbar -->
        <ul id="eliteregister">
...
<script src="<?php echo base_url() ?>File/plugins/bower_components/register-steps/jquery.easing.min.js"></script>
<script src="<?php echo base_url() ?>File/plugins/bower_components/register-steps/register-init.js"></script>
